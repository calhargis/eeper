...
### M6.1 — Thermal capture node & publisher — ✅ [AUTO] done (slices 1–2: node contract + publisher logic ✓, server ingestion + pairing parity ✓); [MANUAL] bench + hardware entrypoint pending (slice 3)
...
- [ ] [M] 24 h physical stream, no I²C lockup; FOV presence visibly registers — ______ (needs the MLX90640 hardware entrypoint, slice 3)
