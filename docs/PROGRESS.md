...
### M4.1 — Trends — 🔨 in progress (slice 1: aggregates + compression foundation ✓)
...
- [ ] [A] Playwright: charts render; CSV export matches; viewer denied export (slice 3 — needs the Trends API + UI)
