...
### M3.1 — MQTT bus & device onboarding — 🔨 in progress (3 slices: broker hardening ✓, devices+ingestion ✓, web)
...
- [ ] [A] Offline detection within heartbeat window, reflected in UI (slice 2 computes online from last_seen; UI is slice 3)
